...
public class TestUtilities {
    ...
    public static Object getPrivateField(Object obj, String field) throws NoSuchFieldException, IllegalAccessException {
        var privateField = obj.getClass().getDeclaredField(field);
        privateField.setAccessible(true);
        return privateField.get(obj);
    }

    public static void runPrivateMethod(Object obj, String method, Object... params) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
